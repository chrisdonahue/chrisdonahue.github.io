...
My research goal is to _develop and responsibly deploy generative AI for music and creativity, augmenting human creative potential and unlocking expression for a broader set of users_. To this end, my work involves (1) improving machine learning methods for controllable generative modeling for music, audio, and other sequential data, and (2) deploying real-world interactive systems that allow a broader audience to harness generative music AI through intuitive controls. 
